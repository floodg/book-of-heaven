-- 2026-04-30: add pgvector-backed chunk storage + search RPC
--   * unified semantic-search rows for diary text (source_type=text)
--     and narration transcripts (source_type=narrated)
--   * this is required for retrieval_mode=pgvector and retrieval_mode=hybrid
